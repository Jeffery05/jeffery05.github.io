...
function App(){
  return (
    ...
    <header>
      <nav>
        <NavLink id="logo" to="/"><svg version="1.1" height="3.4rem" viewBox="0 0 700 700" xmlns="http://www.w3.org/2000/svg">
 <g fill-rule="evenodd" preserveAspectRatio="xMidYMid meet">
  ...
  <path d="m344.21 93.98c4.7617 66.117 66.441 69.734 56.473 105.89-44.246-6.6797-71.398-57.398-56.473-105.89z"/>
        ...
        <a href="https://jefferyhu2005.wixsite.com/portfolio" target="_blank">Tutorials</a>
